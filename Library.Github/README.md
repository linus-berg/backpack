...
This library is primarily used by `Processor.Github.Releases` to extract metadata and dependency information from GitHub
releases. It may also be used by other services needing to interact with GitHub repositories.
