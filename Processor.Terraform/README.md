...
Processor.Terraform is a specialized processor for extracting metadata and dependency information from Terraform modules.

## Key Components

- **TerraformConsumer**: Implements `IConsumer<ArtifactProcessRequest>`, handling metadata extraction for Terraform modules.
